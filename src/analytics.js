...
var Analytics = {
    ...
    _init: function() {
        ...
        Adobe.set("eVar63",String(Util.getCookie("HBSAnalytics")),true); // debug evar
    ...
    save: function(opts) {
        ...
        Adobe.set('prop28',title);
        Adobe.set('eVar64',"D=c28");
...
var User = {
   ...
   _getRolesFromCookie: function() {
     ...
     } else if (/DS/.test(hbscookie)) {
        return ["Doctoral","Doctoral"];
     } else if (/FA/.test(hbscookie)) {
        return ["Faculty","Faculty"];
     } else if (/FE/.test(hbscookie)) {
        return ["Faculty","Faculty"];
     } else if (/FC/.test(hbscookie)) {
        return ["Faculty","Faculty"];
     } else if (/GI/.test(hbscookie)) {
        return ["Faculty","Faculty"];
     } else if (/SF/.test(hbscookie)) {
        return ["Staff","Staff"];
     } else if (/MS/.test(hbscookie) && klass) {
        return ["MBA","MBA "+klass];
     } else if (/MS/.test(hbscookie)) {
        return ["MBA","MBA Unknown"];
     } else if (/CR/.test(hbscookie)) {
        return ["MBA","Crossreg"];
     } else if (/JD/.test(hbscookie)) {
        return ["MBA","Joint Degree"];
     } else if (/ES/.test(hbscookie)) {
        return ["Exed","Exed"];
     } else if (/RCR/.test(hbscookie)) {
        return ["External","Recruiter"];
     } else if (/PT/.test(hbscookie)) {
